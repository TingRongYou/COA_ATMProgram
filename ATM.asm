...
DateTime PROC
    ...
    call WriteDec
    mov edx, OFFSET dash            ;add dash between year and month
    call WriteString

    movzx eax, sysTime.wMonth
    call WriteDec
    mov edx, OFFSET dash            ;add dash between month and day
    call WriteString

    movzx eax, sysTime.wDay
    call WriteDec
    mov edx, OFFSET space           ;add space between date and time
    call WriteString

    ; ==== Print HH:MM:SS ====
    movzx eax, sysTime.wHour
    call WriteDec
    mov edx, OFFSET colon           ;add colon between hour and minute
    call WriteString

    movzx eax, sysTime.wMinute
    call WriteDec
    mov edx, OFFSET colon           ;add colon between minute and second
    call WriteString

    movzx eax, sysTime.wSecond
    call WriteDec                   ;add second
    call Crlf
